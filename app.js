...
console.log('Exercise 4 Result:', generateEmail("kevinatwater", "cpd.com"));
...
console.log('Exercise 5 Result:', greetUser("Voight", "Evening"));
...
console.log('Exercise 6 Result:', maxOfThree(4, 102, 19));
...
function calculateTip(billAmount, tipPrecentage){
    let tip = billAmount * (tipPrecentage/100);
    return tip;
}
